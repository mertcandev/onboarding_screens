...
class CategorySetupFirstTimeFilledScreen extends StatefulWidget {
  const CategorySetupFirstTimeFilledScreen({Key? key}) : super(key: key);

  @override
  State<CategorySetupFirstTimeFilledScreen> createState() =>
      _CategorySetupFirstTimeFilledScreenState();
}

class _CategorySetupFirstTimeFilledScreenState
    extends State<CategorySetupFirstTimeFilledScreen> {
