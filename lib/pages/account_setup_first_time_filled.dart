...
class AccountInfoFirstTimeFilledScreen extends StatefulWidget {
  const AccountInfoFirstTimeFilledScreen({Key? key}) : super(key: key);

  @override
  State<AccountInfoFirstTimeFilledScreen> createState() =>
      _AccountInfoFirstTimeFilledScreenState();
}

class _AccountInfoFirstTimeFilledScreenState
    extends State<AccountInfoFirstTimeFilledScreen> {
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      border:
                          Border.all(color: _buttonGreenColor, width: 1),
                      color: _whiteColor),
                  child: Center(
                    child: Text(
                      _buttonText1,
