...
class ProfileSettingsScreen2 extends StatefulWidget {
  const ProfileSettingsScreen2({Key? key}) : super(key: key);
...
class _ProfileSettingsScreen2State extends State<ProfileSettingsScreen2> {
  ...
  final bool _allowEmailNotification = true;
  final bool _allowReminders = true;
  final bool _enableNotification = true;
  final bool _enableSMSAcceess = true;
  final bool _enablePhotoAccess = true;
  @override
            ...
            child: Container(
                ...
                child: Column(
                  children: [
                      ...
                      child: MediaQuery.removePadding(
                        ...
                        child: ListView(
                          ...
                          children: [
                            Container(
                              padding: EdgeInsets.only(
                                  left: 35.w, right: 30.w, bottom: 12.h),
                              height: 46.h,
                              width: 323.w,
                              child: Center(
                                  child: Row(
                            ...
                            Container(
                              padding: EdgeInsets.only(
                                  left: 35.w, right: 35.w, bottom: 12.h),
                              height: 46.h,
                              width: 323.w,
                              child: Center(
                                  child: Row(
                    ...
                    Padding(
                      padding: EdgeInsets.only(
                          left: 15.5.w, right: 15.5.w, bottom: 8.h, top: 12.h),
                      child: Container(
                        height: 48.h,
                        width: 327.w,
                        decoration: BoxDecoration(
                    ...
                    Padding(
                      padding: EdgeInsets.only(
                          left: 15.5.w, right: 15.5.w, bottom: 8.h),
                      child: Container(
                        height: 48.h,
                        width: 327.w,
                        decoration: BoxDecoration(
                            border: Border.all(color: const Color(0xff5BEFBD)),
                            borderRadius: BorderRadius.circular(30.sp),
                            color: const Color(0xffffffff)),
                        child: Center(
                            child: Text(
                    ...
                    Padding(
                      padding: EdgeInsets.only(
                          left: 15.5.w, right: 15.5.w, bottom: 12.5.h),
                      child: Container(
                        height: 48.h,
                        width: 327.w,
                        decoration: BoxDecoration(
                            border: Border.all(
                                color:
                                    const Color(0xfffe7886).withOpacity(0.5)),
                            borderRadius: BorderRadius.circular(30.sp),
                            color: const Color(0xffffffff)),
                        child: Center(
                            child: Text(
                          ...
                          style: GoogleFonts.inter(
                              fontSize: 16.h,
                              fontWeight: FontWeight.w500,
                              color: const Color(0xfffe7886).withOpacity(0.5)),
                        )),
                      ),
                    ),
                  ],
...
class ShareArrowPainter extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    Path path_0 = Path();
    path_0.moveTo(1.5, 10.8533);
    path_0.lineTo(11.5, 0.853271);
    path_0.moveTo(11.5, 0.853271);
    path_0.lineTo(1.5, 0.853271);
    path_0.moveTo(11.5, 0.853271);
    path_0.lineTo(11.5, 10.8533);

    Paint paint0Stroke = Paint()
      ..style = PaintingStyle.stroke
      ..strokeWidth = size.width * 0.1153846;
    paint0Stroke.color = const Color(0xff242424).withOpacity(1.0);
